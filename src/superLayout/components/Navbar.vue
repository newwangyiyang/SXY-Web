...
import { publicNavRoutes } from '@/router';
...
export default {
	...
	computed: {
		...
		navRoutes() {
			...
			// );
			return [
				{ meta: { title: '数据大盘' }, path: '/superShujudapan' },
				{ meta: { title: '系统配置' }, path: '/superXitongpeizhi' }
			];
		},
		activeMenu() {
...
<template>
	<div class="navbar">
		...
		<div>
			<div class="logo-spec">
				<img src="@/assets/img/logo-white.png" class="sidebar-logo" />
			</div>
			<el-menu
				class="nav-menu"
		...
		<div class="right-menu h-100p flex">
			...
			<el-dropdown class="avatar-container pointer">
				<div class="avatar-wrapper h-80 flex-center">
					<img :src="avatar" class="w-30 h-30 brs15" />
