							...
							<el-tooltip placement="top">
								<template #content>
									<div class="qrcode-img">
										<img class="h-100p w-100p" src="@/assets/img/list-item.png" alt />
									</div>
								</template>
								<el-button type="text" size="small" class="do-btn" @click="handleClick(scope.row)">查看</el-button>
							</el-tooltip>
						</template>
					</el-table-column>
